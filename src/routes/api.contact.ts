                  ...
                  <table role="presentation" width="100%">
                    <tr>
                      <td style="vertical-align:middle;">
                        <img src="cid:${LOGO_CID}" width="160" height="24" alt="Ethixweb" style="display:block;border:0;width:160px;height:24px;" />
